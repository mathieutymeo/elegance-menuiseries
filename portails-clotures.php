...
<body>
  ...
  <nav class="main-nav" id="main-nav" aria-label="Navigation principale">
    ...
    <ul class="main-nav__list" id="nav-list">
      ...
      <li class="main-nav__item"><a href="/portails-clotures.html" class="main-nav__link main-nav__link--active"><span class="main-nav__dot" aria-hidden="true"></span> Clôtures et portails</a></li>
    </ul>
