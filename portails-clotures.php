...
<body>
  ...
  <footer class="site-footer">
    ...
    <div class="site-footer__hero">
      ...
      <a href="<?= e($links['cta_url']) ?>" class="site-footer__cta" target="_blank" rel="noopener"><img src="assets/icons/arrow-right.svg" alt="" width="20" height="12" aria-hidden="true"><span><?= e($footer['cta_label']) ?></span></a>
    </div>
