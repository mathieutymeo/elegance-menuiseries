...
$icons_svg = [
  ...
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="6" y="8" width="28" height="24" rx="1" stroke="#9E8C7D" stroke-width="2"/><line x1="14" y1="8" x2="14" y2="32" stroke="#9E8C7D" stroke-width="1"/><line x1="26" y1="8" x2="26" y2="32" stroke="#9E8C7D" stroke-width="1"/></svg>',
  ...
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><path d="M10 32V14L20 8L30 14V32" stroke="#9E8C7D" stroke-width="2" stroke-linejoin="round"/><line x1="10" y1="32" x2="30" y2="32" stroke="#9E8C7D" stroke-width="2"/><path d="M16 20H24M16 25H24" stroke="#9E8C7D" stroke-width="2" stroke-linecap="round"/></svg>',
...
<head>
  ...
  <meta property="og:url" content="https://elegancemenuiseries.com/fenetres-portes-alu.html">
...
<body>
  ...
  <script>
    ...
    const observer = new IntersectionObserver(([entry]) => nav.classList.toggle('is-sticky', !entry.isIntersecting), { threshold: 0, rootMargin: '0px' });
  ...
  <script>
    ...
    navList.querySelectorAll('.main-nav__link').forEach(link => {
      link.addEventListener('click', () => { navList.classList.remove('is-open'); burger.classList.remove('is-open'); burger.setAttribute('aria-expanded', 'false'); burger.setAttribute('aria-label', 'Ouvrir le menu'); });
    });
  </script>
  ...
  <script>
    ...
    document.querySelectorAll('.gamme-bloc').forEach((bloc) => {
      ...
      gsap.from(bloc.querySelector('.gamme-bloc__visual'), { opacity: 0, x: isLeft ? 80 : -80, duration: 0.9, scrollTrigger: { trigger: bloc, start: 'top 75%' } });
      gsap.from(bloc.querySelector('.gamme-bloc__text'), { opacity: 0, y: 40, duration: 0.7, scrollTrigger: { trigger: bloc, start: 'top 70%' } });
    });
  ...
  <img src="/api/track.php?p=alu" alt="" style="position:absolute;width:1px;height:1px;opacity:0;" aria-hidden="true">
</body>
</html>
