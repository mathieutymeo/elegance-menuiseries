...
$icons_svg = [
  ...
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="6" y="10" width="28" height="20" rx="1" stroke="#9E8C7D" stroke-width="2"/><line x1="6" y1="16" x2="34" y2="16" stroke="#9E8C7D" stroke-width="1.5"/><line x1="6" y1="22" x2="34" y2="22" stroke="#9E8C7D" stroke-width="1.5"/><line x1="6" y1="28" x2="34" y2="28" stroke="#9E8C7D" stroke-width="1.5"/></svg>',
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><path d="M20 8L20 32" stroke="#9E8C7D" stroke-width="2" stroke-linecap="round"/><path d="M14 14L20 8L26 14" stroke="#9E8C7D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="20" cy="24" r="3" stroke="#9E8C7D" stroke-width="2"/></svg>',
  ...
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="10" y="8" width="20" height="24" rx="2" stroke="#9E8C7D" stroke-width="2"/><circle cx="20" cy="20" r="4" stroke="#9E8C7D" stroke-width="2"/><path d="M20 24V28" stroke="#9E8C7D" stroke-width="2" stroke-linecap="round"/></svg>',
...
<head>
  ...
  <meta property="og:url" content="https://elegancemenuiseries.com/portes-garage.html">
...
<body>
  ...
  <nav class="main-nav" id="main-nav" aria-label="Navigation principale">
    ...
    <ul class="main-nav__list" id="nav-list">
      ...
      <li class="main-nav__item"><a href="/fenetres-portes-alu.html" class="main-nav__link"><span class="main-nav__dot" aria-hidden="true"></span> Fenêtres / Portes Alu</a></li>
      ...
      <li class="main-nav__item"><a href="/portes-garage.html" class="main-nav__link main-nav__link--active"><span class="main-nav__dot" aria-hidden="true"></span> Portes de garage</a></li>
  ...
  <section class="section-intro-produit" id="portes-garage">
  ...
  <footer class="site-footer">
    ...
    <address class="site-footer__address"><?= e($footer['nom']) ?><br><?= e($footer['adresse']) ?><br><?= e($footer['adresse2'] ?? '') ?><br><br><a href="tel:<?= preg_replace('/\s/', '', $footer['telephone']) ?>" style="color:inherit;text-decoration:none;"><?= e($footer['telephone']) ?></a><br><a href="mailto:<?= e($footer['email']) ?>" style="color:inherit;text-decoration:none;"><?= e($footer['email']) ?></a></address>
  ...
  <script>
    ...
    const heroTl=gsap.timeline({defaults:{ease:'power3.out'}});heroTl.from('.hero-produit__panel',{x:'-100%',duration:0.8}).from('.hero-produit__logo',{opacity:0,scale:0.8,duration:1},'-=0.4').from('.hero-produit__title',{opacity:0,x:-60,duration:0.8},'-=0.5').from('.hero-produit__tagline',{opacity:0,duration:0.8},'-=0.3');
    gsap.from('.intro-produit__body',{opacity:0,y:50,duration:0.8,scrollTrigger:{trigger:'.intro-produit__body',start:'top 80%'}});gsap.from('.intro-produit__cta',{opacity:0,y:30,duration:0.6,scrollTrigger:{trigger:'.intro-produit__cta',start:'top 90%'}});
    ...
    gsap.from('.section-promesse-produit .section-label',{opacity:0,y:30,duration:0.6,scrollTrigger:{trigger:'.section-promesse-produit',start:'top 80%'}});gsap.from('.promesse-produit__body',{opacity:0,y:50,duration:0.8,scrollTrigger:{trigger:'.promesse-produit__body',start:'top 80%'}});gsap.from('.promesse-produit__cta',{opacity:0,y:30,duration:0.6,scrollTrigger:{trigger:'.promesse-produit__cta',start:'top 90%'}});gsap.from('.promesse-produit__photo-wrap--1',{opacity:0,x:-60,duration:0.8,scrollTrigger:{trigger:'.promesse-produit__photos',start:'top 80%'}});gsap.from('.promesse-produit__photo-wrap--2',{opacity:0,scale:0.8,duration:0.7,scrollTrigger:{trigger:'.promesse-produit__photos',start:'top 75%'}});gsap.from('.promesse-produit__photo-wrap--3',{opacity:0,y:60,duration:0.9,scrollTrigger:{trigger:'.promesse-produit__photos',start:'top 70%'}});
    gsap.from('.site-footer__logo',{opacity:0,scale:0.85,duration:0.8,scrollTrigger:{trigger:'.site-footer',start:'top 80%'}});gsap.from('.site-footer__cta',{opacity:0,y:30,duration:0.6,scrollTrigger:{trigger:'.site-footer__cta',start:'top 90%'}});gsap.from('.site-footer__address',{opacity:0,y:20,duration:0.6,scrollTrigger:{trigger:'.site-footer__address',start:'top 90%'}});gsap.from('.site-footer__legal',{opacity:0,duration:0.5,scrollTrigger:{trigger:'.site-footer__legal',start:'top 95%'}});
  </script>
  <img src="/api/track.php?p=garage" alt="" style="position:absolute;width:1px;height:1px;opacity:0;" aria-hidden="true">
</body>
</html>
