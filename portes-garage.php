...
<body>
  ...
  <nav class="main-nav" id="main-nav" aria-label="Navigation principale">
    ...
    <ul class="main-nav__list" id="nav-list">
      ...
      <li class="main-nav__item"><a href="#portes-garage" class="main-nav__link main-nav__link--active"><span class="main-nav__dot" aria-hidden="true"></span> Portes de garage</a></li>
