...
$icons_svg = [
  ...
  '<svg width="40" height="40" viewBox="0 0 40 40" fill="none"><rect x="8" y="10" width="24" height="20" rx="2" stroke="#9E8C7D" stroke-width="2"/><circle cx="20" cy="20" r="3" stroke="#9E8C7D" stroke-width="2"/><path d="M12 10V8a8 8 0 0116 0v2" stroke="#9E8C7D" stroke-width="2"/></svg>',
...
<head>
  ...
  <meta property="og:url" content="https://elegancemenuiseries.com/volets-roulants.html">
...
<body>
  ...
  <nav class="main-nav" id="main-nav" aria-label="Navigation principale">
    ...
    <ul class="main-nav__list" id="nav-list">
      ...
      <li class="main-nav__item"><a href="/volets-roulants.html" class="main-nav__link main-nav__link--active"><span class="main-nav__dot" aria-hidden="true"></span> Volets roulants</a></li>
  ...
  <img src="/api/track.php?p=volets" alt="" style="position:absolute;width:1px;height:1px;opacity:0;" aria-hidden="true">
</body>
</html>
